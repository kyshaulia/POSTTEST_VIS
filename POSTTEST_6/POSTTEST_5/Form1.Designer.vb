...
Partial Class FormDashboard
    ...
    Private Sub InitializeComponent()
        ...
        MenuStrip1.Items.AddRange(New ToolStripItem() {menuDataHIjab, menuTransaksi, menuKeluar})
        ...
        menuDataHIjab.Size = New Size(83, 21)
        menuDataHIjab.Text = "Data Hijab"
        ' 
        ' menuTransaksi
        ' 
        menuTransaksi.BackColor = Color.SteelBlue
        menuTransaksi.Font = New Font("Segoe UI Semibold", 9.75F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        menuTransaksi.ForeColor = Color.White
        menuTransaksi.Name = "menuTransaksi"
        menuTransaksi.Size = New Size(75, 21)
        ...
        menuKeluar.ForeColor = SystemColors.ButtonHighlight
        ...
        PictureBox1.Location = New Point(218, -95)
